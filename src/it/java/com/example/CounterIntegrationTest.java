...
public class CounterIntegrationTest {
  ...
  public void increaseOnNonExistingEntity() throws Exception {
    ...
    client.increase(CounterApi.IncreaseValue.newBuilder().setCounterId("foo").setValue(1).build())
             .toCompletableFuture().get(5, SECONDS);
    CounterApi.CurrentCounter counter = client.getCurrentCounter(CounterApi.GetCounter.newBuilder().setCounterId("foo").build())
            .toCompletableFuture().get(5, SECONDS);
